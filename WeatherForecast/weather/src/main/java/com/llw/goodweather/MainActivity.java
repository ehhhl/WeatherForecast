...
public class MainActivity extends MvpVBActivity<ActivityMainBinding, WeatherContract.WeatherPresenter>
    ...
    public void initData() {
        ...
        initList();//天气预报列表初始化
        district = getIntent().getStringExtra("district");//获取区/县
        city = getIntent().getStringExtra("city");//获取市
    ...
    public void getAirNowResult(AirNowResponse response) {
        if (response.getCode().equals(Constant.SUCCESS_CODE)) {
            ...
            if (response.getNow() != null) {
                ...
                binding.rpbAqi.setArcBgColor(getColor(com.llw.mvplibrary.R.color.arc_bg_color));//圆弧的颜色
                binding.rpbAqi.setProgressColor(getColor(com.llw.mvplibrary.R.color.arc_progress_color));//进度圆弧的颜色
                ...
                binding.rpbAqi.setMinTextColor(getColor(com.llw.mvplibrary.R.color.arc_progress_color));
