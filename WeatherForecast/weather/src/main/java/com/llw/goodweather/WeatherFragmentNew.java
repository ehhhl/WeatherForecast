...
import com.llw.mvplibrary.mvp.MvpVBFragment;
...
public class WeatherFragmentNew extends MvpVBFragment<ActivityMainBinding, WeatherContract.WeatherPresenter>
...
//            startActivity(new Intent(context, MapWeatherActivity.class));
            ...
            startActivity(intent);
        } else if (id == R.id.iv_voice_broadcast) {//语音播报

        } else if (id == R.id.tv_city) {//当用户没有打开GPS定位时，则可以点击这个TextView进行重新定位
        ...
        } else if (id == R.id.tv_more_daily) {//更多天气预报
            goToMore(MoreDailyActivity.class);
        } else if (id == R.id.tv_more_air) {//更多空气质量信息
            goToMore(MoreAirActivity.class);
        } else if (id == R.id.tv_more_lifestyle) {//更多生活建议
            goToMore(MoreLifestyleActivity.class);
        } else if (id == R.id.tv_prec_more) {//分钟级降水详情
            if (state) {//收缩
        ...
        } else if (id == R.id.fab_voice_search) {//语音搜索
    ...
    public void getAirNowResult(AirNowResponse response) {
        if (response.getCode().equals(Constant.SUCCESS_CODE)) {
            ...
            if (response.getNow() != null) {
                ...
                binding.rpbAqi.setArcBgColor(   context.getColor(com.llw.mvplibrary.R.color.arc_bg_color));//圆弧的颜色
                binding.rpbAqi.setProgressColor(context.getColor(com.llw.mvplibrary.R.color.arc_progress_color));//进度圆弧的颜色
                ...
                binding.rpbAqi.setMinTextColor(context.getColor(com.llw.mvplibrary.R.color.arc_progress_color));
...
//        dismissLoadingDialog();//关闭弹窗
    ...
    private void showAddWindow() {
        ...
        mPopupWindow.setAnimationStyle(com.llw.mvplibrary.R.style.pop_add);// 设置pop出入动画
