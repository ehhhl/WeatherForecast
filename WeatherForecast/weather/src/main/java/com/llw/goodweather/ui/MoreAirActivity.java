...
public class MoreAirActivity extends MvpVBActivity<ActivityMoreAirBinding, MoreAirContract.MoreAirPresenter> implements MoreAirContract.IMoreAirView {
    ...
    private void showAirBasicData(AirNowResponse.NowBean data) {
        ...
        binding.rpbAqi.setArcBgColor(getResources().getColor(com.llw.mvplibrary.R.color.arc_bg_color));//圆弧的颜色
        binding.rpbAqi.setProgressColor(getResources().getColor(com.llw.mvplibrary.R.color.arc_progress_color));//进度圆弧的颜色
        ...
        binding.rpbAqi.setMinTextColor(getResources().getColor(com.llw.mvplibrary.R.color.arc_progress_color));
